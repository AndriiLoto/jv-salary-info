...
public class SalaryInfo {
    ...
    public String getSalaryInfo(String[] names, String[] data, String dateFrom, String dateTo) {
        ...
        builder.append(startDate.format(FORMATTER)).append(" - ").append(endDate.format(FORMATTER)).append(System.lineSeparator());
        ...
        for (String name : names) {
            ...
            for (String record : data) {
                ...
                if (name.equals(employeeName) && !recordDate.isBefore(startDate) && !recordDate.isAfter(endDate)) {
